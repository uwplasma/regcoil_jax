...
```bash
python examples/jax_optimize_coil_minor_radius.py
```
...
- ✅ Includes pytest regression tests (`tests/`) with stored baselines.

See `PORT_NOTES.md` for details on what was fixed and how to validate parity.
