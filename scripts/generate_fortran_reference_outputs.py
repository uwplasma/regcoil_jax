...
def main() -> None:
    ...
    if args.inputs:
        ...
        inputs = [
            ...
            Path("examples/1_simple/regcoil_in.nlambda2_corner"),
            ...
            Path("examples/2_intermediate/regcoil_in.torus_svd_scan"),
            Path("examples/2_intermediate/regcoil_in.torus_nescout_diagnostics"),
            Path("examples/2_intermediate/regcoil_in.lambda_search_option4_torus"),
            Path("examples/2_intermediate/regcoil_in.lambda_search_option4_torus_max_K_lse"),
            Path("examples/2_intermediate/regcoil_in.lambda_search_option4_torus_lp_norm_K"),
            Path("examples/2_intermediate/regcoil_in.plasma_option_5_efit_lcfs"),
            Path("examples/2_intermediate/regcoil_in.torus_sensitivity_option2_small"),
